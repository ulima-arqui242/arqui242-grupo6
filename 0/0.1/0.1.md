...
6. Revisar el detalle y los resultados de la prueba en el dashboard de App Automate. Se muestra información como: los dispositivos testeados, la duración de la prueba y éxito de la prueba.
![App Automate Results](app_automate_results.png)
