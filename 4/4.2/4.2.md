...
Encapsular la lógica de las métricas dentro de un módulo específico permite centralizar y simplificar futuras modificaciones. Esto facilita el mantenimiento y reduce el riesgo de introducir errores en otras partes de la aplicación, mejorando así la mantenibilidad general del sistema.
...
1. Reducir Acoplamiento
   ...
   Esto permite que se puedan hacer cambios en la lógica de amigos sin que afecte a módulos relacionados, como notificaciones o hábitos.
