...
| **Atributo de Calidad** | **Estímulo**   | **Fuente del Estímulo**                                  | **Artefacto**        | **Entorno**                      | **Respuesta**                                                      | **Medida de Respuesta**                                                                    |
| ----------------------- | -------------- | -------------------------------------------------------- | -------------------- | -------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ |
| ESC-04                  | Actualizaciones en la lógica de conexión y progreso de amigo | Equipo de desarrollo | Módulo de Amigos | Entorno de desarrollo y producción | Las modificaciones se implementan de la forma más rápida | Los cambios están en producción en 2 horas |
...
1. Reducir Acoplamiento
   ...
   Establecer interfaces claras que desacoplen el módulo de amigos de los otros componentes del sistema.
   Esto permite que se puedan hacer cambios en la lógica de amigos sin que afecte a módulos relacionados, como mensajeria.
   Facilita el mantenimiento y disminuye el riesgo de introducir errores.

2. Encapsulamiento

   Mantener las funciones del módulo de amigos bien agrupadas y organizadas.
   Aunque mejora la claridad interna, no resuelve el problema de interdependencia con otros módulos, lo que puede ralentizar las actualizaciones.


### Criterios de Elección

1. Facilitar el mantenimiento a largo plazo.
2. Evitar errores que puedan salir al realizar actualizaciones.
3. Acelerar el tiempo para que los cambios lleguen a producción.

### Decisión

Se eligió Reducir el acoplamiento

### Sustento

Desacoplar el Módulo de Amigos de otros componentes es mejor implementar cambios de manera rápida y segura. De esta forma, podemos actualizar este módulo sin afectar a otros y garantizar que los nuevos cambios lleguen a producción en un plazo de máximo 2 horas. Además, al reducir dependencias, el módulo podrá evolucionar de forma más flexible y escalable en el futuro.
