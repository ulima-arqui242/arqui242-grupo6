...
| **Cod Escenario** | **Atributo de Calidad** | **Fuente del Estímulo**      | **Estímulo**                                     | **Artefacto**      | **Entorno**          | **Respuesta**                                                                 | **Medida de Respuesta**                              |
|--------------------|-------------------------|------------------------------|-------------------------------------------------|--------------------|----------------------|--------------------------------------------------------------------------------|-----------------------------------------------------|
| QA-01             | Disponibilidad         | Alta demanda de usuarios     | Gran cantidad de usuarios accede al sistema simultáneamente | Sistema completo | Operación en horas pico | El sistema debe redirigir a un servidor de respaldo para evitar caída de servicio. | Garantizar una disponibilidad del 99% durante picos de tráfico. |
