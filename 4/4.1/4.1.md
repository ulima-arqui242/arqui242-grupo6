...
**Implementacón de Tácticas de Disponibilidad**

- Reintentos: En caso de falla en la conexión, el módulo intentará varias veces sincronizar los datos. Los intentos se limitan para evitar bucles infinitos o una sobrecarga innecesaria del sistema.

- Operación en Modo Offline: Cuando la conexión a la base de datos falla, los datos se almacenan localmente en el dispositivo del usuario y luego se sincronizan cuando la conexión vuelve a estar disponible.

- Redundancia Pasiva: Se mantienen copias de los datos en nodos secundarios que pueden ser activados si el nodo principal falla, garantizando la continuidad del servicio.
...
Para seleccionar la táctica de disponibilidad más adecuada para el módulo de Seguimiento, se tomaron en cuenta los siguientes criterios:
...
Se eligió la Redundancia Pasiva y el uso de Reintentos para manejar fallas temporales en la conexión. Esta solución permite mantener la disponibilidad del módulo de Seguimiento, almacenando datos localmente y sincronizándolos cuando sea posible.
