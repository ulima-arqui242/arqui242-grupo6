...
|----------------|-------------|
| CON-01         | La app debe ser capaz de manejar al menos 10,000 usuarios concurrentes. |
| CON-02         | La autenticación debe ser a través de HTTPS. |
| CON-03         | La app debe optimizar la carga de datos para no superar los 3 segundos de espera. |
